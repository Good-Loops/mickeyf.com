...
import { loadAppleRevocationConfig } from './appleRevocationConfig';
...
test('explicit apply constructs only the reviewed production socket config and inert lifecycle dependencies', () => {
    ...
    assert.equal(config.lifecycle.clientId, environment.APPLE_IOS_BUNDLE_ID);
