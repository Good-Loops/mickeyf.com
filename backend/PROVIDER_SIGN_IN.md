...
Configuration and startup fail closed for incomplete keys or missing schema;
no credentials are generated by these commands. Keep historical decryption keys
