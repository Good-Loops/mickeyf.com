...
/// <summary>
/// Adapts the isolated Figma menu import to the existing run and audio services.
/// The production menu and its fade remain independent of this experimental scene.
/// </summary>
...
public sealed class MainMenuToolkitPilot : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        {
            Debug.LogError($"Main Menu UI Toolkit pilot: {error}", this);
            enabled = false;
            return;
        }
    ...
    /// The pilot panel uses constant pixel size at scale 1, so 48 panel units are 48 screen pixels.
    /// </summary>
